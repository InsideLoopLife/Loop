    ...
    try {
      ...
      for (const parsed of parsedDeals) {
        const row = {
          ...
          evidence: {
            rate: parsed.grossAer,
            accessType: parsed.accessType ?? null,
            minimumBalance: parsed.minimumBalance ?? null,
            maximumBalance: parsed.maximumBalance ?? null,
            monthlyMinimum: parsed.monthlyMinDeposit ?? null,
            monthlyMaximum: parsed.monthlyMaxDeposit ?? null,
            noticeDays: parsed.noticePeriodDays ?? null,
            termMonths: parsed.termLengthMonths ?? null,
          },
