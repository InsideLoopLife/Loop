...
// Moneybox Cash Trust (GB00B0CNHB64) is deliberately absent. Until a live
// quote can be identity-checked against a reliable NAV source, the worker must
// preserve its last trusted value instead of manufacturing a price movement.
