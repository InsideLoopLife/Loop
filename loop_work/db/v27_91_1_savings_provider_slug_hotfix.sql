...
-- Fixes: column "provider_slug" does not exist / cannot be referenced from this part of the query
-- Cause: v27.91 assumed v27.87 had already added provider_slug to financial_accounts and used unqualified column names in an INSERT...SELECT.
