-- v27.91.2 - Savings match view hotfix
-- Fixes: cannot change name of view column "requires_existing_customer" to "rate_delta".
-- Cause: CREATE OR REPLACE VIEW cannot reorder/rename existing view columns. Drop the read-only helper view before recreating it.
