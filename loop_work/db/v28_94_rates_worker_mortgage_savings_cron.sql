...
values (
  'v28_94_rates_worker_mortgage_savings_cron',
  'Combined savings, mortgage and daily maintenance worker',
  'Adds deterministic required-field validation, monthly savings limits, stable product identity, three-observation withdrawal handling and mortgage anomaly quarantine.',
  '{"areas":["savings","mortgages","cron","expiry","shortlisting"],"requires_sql":true,"worker_version":"2.0.0"}'::jsonb,
  now()
)
