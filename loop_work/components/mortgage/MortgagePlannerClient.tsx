...
function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-slate-950/50 p-0 backdrop-blur-sm sm:items-center sm:p-6">
      <div className="max-h-[92vh] w-full overflow-y-auto rounded-t-[2rem] border border-white/70 bg-white p-6 text-slate-950 shadow-2xl backdrop-blur-2xl sm:max-w-5xl sm:rounded-[2rem]">
