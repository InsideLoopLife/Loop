...
- `createServerSupabaseClient` import path in the API route — swap to match whatever you use elsewhere in `app/api/**`.
- `useHouseholdMembers` hook in `ScopeBadge.tsx` — point at your real household members hook/query if named differently.
